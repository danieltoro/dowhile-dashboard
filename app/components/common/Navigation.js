        ...
        return (
            <nav className="navbar-default navbar-static-side" role="navigation">
                    <ul className="nav metismenu" id="side-menu" ref="menu">
                        ...
                        <li className={this.activeRoute("/categorias")}>
                            <Link to="/categorias"><i className="fa fa-th-large"></i> <span className="nav-label">Categorias</span></Link>
                        </li>
                        <li className={this.activeRoute("/productos")}>
                            <Link to="/productos"><i className="fa fa-th-large"></i> <span className="nav-label">Productos</span></Link>
                        </li>
